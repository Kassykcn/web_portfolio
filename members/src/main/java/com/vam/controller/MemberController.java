...
public class MemberController {
 ...
 if(login == null) {                                // 일치하지 않는 아이디, 비밀번호 입력 경우
    ...
    public String memberUpdate(MemberVO member, HttpSession session) throws Exception{
 ...
 // 아이디 찾기 
	...
	public String find_id(MemberVO member, @RequestParam("email") String email, Model md) throws Exception{
		md.addAttribute("id", memberservice.memberFind(member, email));
	...
	// 비밀번호 찾기 
		...
		public String find_pass(MemberVO member, @RequestParam("id") String id, Model md) throws Exception{
			md.addAttribute("pass", memberservice.passFind(member, id));
