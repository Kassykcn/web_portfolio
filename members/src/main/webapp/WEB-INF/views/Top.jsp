...
<%
	...
	log = "<a style=\"text-decoration: none; color:black; font-size:13px;\" href=" + "member/logout" + ">로그아웃</a>";
	mem = "<a style=\"text-decoration: none; color:black; font-size:13px;\" href=" + "test2.jsp" + ">마이페이지</a>";
%>
<div align = "right" style="padding-right:70px">
	<tr>
		<td><%=log %></td>
